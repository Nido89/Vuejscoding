    ...
    data: () => {
      return {
        cards: [
          {
            id: 1,
            title: "Sunshine is Life in Finland",
            description:
              "One can never guess the importance of sunshine or sunlight in there Life till they encounter the harsh reality of living in a land with a few days of sunlight. But now living in Finland makes me fall in Love with this sunlight.",
            img: "/slider_01.jpg",
            open: false
          },
          {
